                        ...
                        <?php foreach ($counters as $counter) : $current++; ?>
                            <div class="short-counter">
                                ...
                                <div class="short-counter-text">
                                    <span class="short-counter-number" data-target="<?php echo esc_attr($counter['sv_counter_number']); ?>">
                                        <?php echo esc_html($counter['sv_counter_number']); ?>
                                    </span>
