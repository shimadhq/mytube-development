...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login_submit'])) {
    $creds = array(
        'user_number'    => sanitize_text_field($_POST['number']),
            ...
            <div class="auth-section">
                ...
                <form method="post" class="auth-form">
                    <div class="auth-form-input">
                        <label for="number" class="auth-form-label">شماره همراه</label>
                    ...
                    <div>
                        <input type="submit" name="login_submit" value="ورود" class="auth-submit-button">
                    </div>
                </form>
                <p class="auth-link">
                    <span class="auth-link-text">حساب کاربری نداری؟</span>
                    <a href="<?php echo site_url('/register'); ?>" class="auth-link-register">ثبت‌نام</a>
                </p>
            </div>
